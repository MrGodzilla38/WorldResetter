...
- **Skip unnecessary generation.** If players never explore for loot, you can turn off village/stronghold generation entirely — this makes new worlds generate faster.
